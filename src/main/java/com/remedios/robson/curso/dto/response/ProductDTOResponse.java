package com.remedios.robson.curso.dto.response;
...
public class ProductDTOResponse {
    ...
    public ProductDTOResponse(String description, Way way, String lote, Integer quantity, Instant validity, Laboratory laboratory) {
